...
/*----------------------------------------------------------------------------------------------------*/
#if defined (_PPI_PPS_V2) || defined (_PPI_PPS_V3) || defined (_PPI_PPS_V5)
...
#if defined (_PPI_PPS_V4) || defined (_PPI_PPS_V5)
#define IN_PIN_PPS_RPI16			16					/* Assign RP16 as Input Pin */
#define IN_PIN_PPS_RPI17			17					/* Assign RP17 as Input Pin */
#define IN_PIN_PPS_RPI18			18					/* Assign RP18 as Input Pin */
#define IN_PIN_PPS_RPI19			19					/* Assign RP19 as Input Pin */
#define IN_PIN_PPS_RP20			20					/* Assign RP20 as Input Pin */
#endif

#if defined (_PPI_PPS_V1)
...
#define IN_PIN_PPS_RP24			24					/* Assign RPI24 as Input Pin */
#define IN_PIN_PPS_RP25			25					/* Assign RPI25 as Input Pin */
#endif
...
#define IN_PIN_PPS_RP102			102					/* Assign RP102 as Input Pin */
...
#elif defined (_PPI_PPS_V4) || defined (_PPI_PPS_V5)
...
#define IN_PIN_PPS_RPI46			46					/* Assign RPI46 as Input Pin */
#define IN_PIN_PPS_RPI47			47					/* Assign RPI47 as Input Pin */
#define IN_PIN_PPS_RP48				48					/* Assign RP48 as Input Pin */
#define IN_PIN_PPS_RP49				49					/* Assign RP49 as Input Pin */
#define IN_PIN_PPS_RPI50			50				    /* Assign RPI50 as Input Pin */
#define IN_PIN_PPS_RPI51			51					/* Assign RPI51 as Input Pin */
#define IN_PIN_PPS_RPI52			52					/* Assign RPI52 as Input Pin */
#define IN_PIN_PPS_RPI53			53					/* Assign RPI53 as Input Pin */
#define IN_PIN_PPS_RP54				54					/* Assign RP54 as Input Pin */
...
#define IN_PIN_PPS_RP57				57					/* Assign RP57 as Input Pin */
#define IN_PIN_PPS_RPI58			58					/* Assign RPI58 as Input Pin */
#define IN_PIN_PPS_RPI60			60					/* Assign RPI60 as Input Pin */
#define IN_PIN_PPS_RPI61			61					/* Assign RPI61 as Input Pin */
#define IN_PIN_PPS_RPI63			63					/* Assign RPI63 as Input Pin */
#define IN_PIN_PPS_RP69				69					/* Assign RP69 as Input Pin */
#define IN_PIN_PPS_RP70				70					/* Assign RP70 as Input Pin */
#define IN_PIN_PPS_RPI72			72					/* Assign RPI72 as Input Pin */
#define IN_PIN_PPS_RPI94			94					/* Assign RPI94 as Input Pin */
#define IN_PIN_PPS_RPI95			95					/* Assign RPI95 as Input Pin */
#define IN_PIN_PPS_RPI96			96					/* Assign RPI96 as Input Pin */
#define IN_PIN_PPS_RP97			    97					/* Assign RP97 as Input Pin */
...
#define IN_PIN_PPS_RPI121			121					/* Assign RPI121 as Input Pin */
#ifdef _PPI_PPS_V5
#define IN_PIN_PPS_RPI124			124					/* Assign RPI124 as Input Pin */
#define IN_PIN_PPS_RP125			125					/* Assign RP125 as Input Pin */
#define IN_PIN_PPS_RP126			126					/* Assign RP126 as Input Pin */
#define IN_PIN_PPS_RP127			127					/* Assign RP127 as Input Pin */
#define IN_PIN_PPS_RP176			176					/* Assign RP176 as Input Pin */
#define IN_PIN_PPS_RP177			177					/* Assign RP177 as Input Pin */
#define IN_PIN_PPS_RP178			178					/* Assign RP178 as Input Pin */
#define IN_PIN_PPS_RP179			179					/* Assign RP179 as Input Pin */
#define IN_PIN_PPS_RP180			180					/* Assign RP180 as Input Pin */
#define IN_PIN_PPS_RP181			181					/* Assign RP181 as Input Pin */
#endif

#elif defined (_PPI_PPS_V6)

#define IN_PIN_PPS_RP32			32		/* Assign RP32 as Input Pin */
#define IN_PIN_PPS_RP33			33		/* Assign RP33 as Input Pin */
#define IN_PIN_PPS_RP34			34		/* Assign RP34 as Input Pin */
#define IN_PIN_PPS_RP35			35		/* Assign RP35 as Input Pin */
#define IN_PIN_PPS_RP36			36		/* Assign RP36 as Input Pin */
#define IN_PIN_PPS_RP37			37		/* Assign RP37 as Input Pin */
#define IN_PIN_PPS_RP38			38		/* Assign RP38 as Input Pin */
...
#define IN_PIN_PPS_RP42			42		/* Assign RP42 as Input Pin */
#define IN_PIN_PPS_RP43			43		/* Assign RP43 as Input Pin */
#define IN_PIN_PPS_RP44			44		/* Assign RP44 as Input Pin */
#define IN_PIN_PPS_RP45			45		/* Assign RP45 as Input Pin */
#define IN_PIN_PPS_RP46			46		/* Assign RP46 as Input Pin */
#define IN_PIN_PPS_RP47			47		/* Assign RP47 as Input Pin */
#define IN_PIN_PPS_RP48			48		/* Assign RP48 as Input Pin */
#define IN_PIN_PPS_RP49			49		/* Assign RP49 as Input Pin */
#define IN_PIN_PPS_RP50			50		/* Assign RP50 as Input Pin */
#define IN_PIN_PPS_RP51			51		/* Assign RP51 as Input Pin */
#define IN_PIN_PPS_RP52			52		/* Assign RP52 as Input Pin */
#define IN_PIN_PPS_RP53			53		/* Assign RP53 as Input Pin */
#define IN_PIN_PPS_RP54			54		/* Assign RP54 as Input Pin */
#define IN_PIN_PPS_RP55			55		/* Assign RP55 as Input Pin */
#define IN_PIN_PPS_RP56			56		/* Assign RP56 as Input Pin */
#define IN_PIN_PPS_RP57			57		/* Assign RP57 as Input Pin */
#define IN_PIN_PPS_RP58			58		/* Assign RP58 as Input Pin */
#define IN_PIN_PPS_RP59			59		/* Assign RP59 as Input Pin */
...
#if defined (_PPI_PPS_V5) || defined (_PPI_PPS_V6)
...
#if defined (_PPI_PPS_V2) || defined (_PPI_PPS_V3) || defined (_PPI_PPS_V6)
...
#elif (defined (_PPI_PPS_V2) || defined (_PPI_PPS_V3) || defined (_PPI_PPS_V6)) && !defined (_C5EVT)
#define IN_FN_PPS_IC3				RPINR8bits.IC3R		/* Assign Input Capture 3 (IC3) to the corresponding RPn pin*/
#define IN_FN_PPS_IC4				RPINR8bits.IC4R		/* Assign Input Capture 4 (IC4) to the corresponding RPn pin*/
#define IN_FN_PPS_SDI1				RPINR20bits.SDI1R	/* Assign SPI1 Data Input (SDI1) to the corresponding RPn pin*/
#define IN_FN_PPS_SCK1				RPINR20bits.SCK1R	/* Assign SPI1 Clock Input (SCK1IN) to the corresponding RPn pin*/
...
#if !defined (_PPI_PPS_V4) && !defined (_PPI_PPS_V6)
...
#define IN_FN_PPS_FLT8				RPINR43bits.FLT8R		/* Assign PWM8 Fault (FLT8) to the corresponding RPn pin*/
...
#if defined (_PPI_PPS_V2)|| defined (_PPI_PPS_V3) || defined (_PPI_PPS_V4)
#define IN_FN_PPS_QEH1				RPINR15bits.HOME1R	/* Assign QEI HOME to the corresponding RPn pin*/
#endif

#if defined (_PPI_PPS_V1) || defined (_PPI_PPS_V2) || defined (_PPI_PPS_V3)
...
#if defined (_PPI_PPS_V1) || defined (_PPI_PPS_V2) || defined (_PPI_PPS_V3) || defined (_PPI_PPS_V6)
...
#elif defined (_PPI_PPS_V5)
#define IN_FN_PPS_SYNCI1			RPINR37bits.SYNCI1R	/* Assign PWM Sync Input 1 (SYNCI1) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP1			RPINR38bits.DTCMP1R	/* Assign PWM Dead Time Compensation 1 (DTCMP1) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP2			RPINR39bits.DTCMP2R	/* Assign PWM Dead Time Compensation 2 (DTCMP2) to the corresponding RPn pin*/
#define IN_FN_PPS_DTCMP3			RPINR39bits.DTCMP3R	/* Assign PWM Dead Time Compensation 3 (DTCMP3) to the corresponding RPn pin*/
#define IN_FN_PPS_SENT1				RPINR44bits.SENT1R  /* Assign SENT module input 1 (SENT1) to the corresponding RPn pin*/
#define IN_FN_PPS_SENT2				RPINR45bits.SENT2R  /* Assign SENT module input 2 (SENT2) to the corresponding RPn pin*/
#endif
...
#define OUT_FN_PPS_C4OUT			0x0032				/* RPn tied to Comparator4 Output */
#define OUT_FN_PPS_C5OUT			0x0033				/* RPn tied to Comparator5 Output */
#define OUT_FN_PPS_SENT1			0x0039				/* RPn tied to SENT1 Output */
#define OUT_FN_PPS_SENT2			0x003A				/* RPn tied to SENT2 Output */
...
#define OUT_FN_PPS_OC3			0x0012				/* RPn tied to Output Compare 3 */
#define OUT_FN_PPS_OC4			0x0013				/* RPn tied to Output Compare 4 */
#define OUT_FN_PPS_ACMP1			0x0018				/* RPn tied to Comparator1 Output */
#define OUT_FN_PPS_ACMP2			0x0019				/* RPn tied to Comparator2 Output */
#define OUT_FN_PPS_ACMP3			0x001A				/* RPn tied to Comparator3 Output */
#define OUT_FN_PPS_SYNCO1		0x002D				/* RPn tied to Output SYNCO1 */
#define OUT_FN_PPS_SYNCO2		0x002E				/* RPn tied to Output SYNCO2 */
#define OUT_FN_PPS_REFCLKO		0x0031				/* RPn tied to Output REFCLKO */
#define OUT_FN_PPS_ACMP4			0x0032				/* RPn tied to Comparator4 Output */
#define OUT_FN_PPS_PWM4H		0x0033				/* RPn tied to Output PWM4H */
#define OUT_FN_PPS_PWM4L			0x0034				/* RPn tied to Output PWM4L */
#define OUT_FN_PPS_PWM5H		0x0035				/* RPn tied to Output PWM5H */
#define OUT_FN_PPS_PWM5L			0x0036				/* RPn tied to Output PWM5L */
...
#define OUT_PIN_PPS_RP70			RPOR8bits.RP70R		/* Assign RP70 as Output Pin */
#define OUT_PIN_PPS_RP97			RPOR9bits.RP97R		/* Assign RP97 as Output Pin */
#define OUT_PIN_PPS_RP118			RPOR9bits.RP118R	/* Assign RP97 as Output Pin */
#define OUT_PIN_PPS_RP120			RPOR10bits.RP120R	/* Assign RP120 as Output Pin */
#define OUT_PIN_PPS_RP176			RPOR10bits.RP176R	/* Assign RP176 as Output Pin */
#define OUT_PIN_PPS_RP177			RPOR11bits.RP177R	/* Assign RP177 as Output Pin */
#define OUT_PIN_PPS_RP178			RPOR11bits.RP178R	/* Assign RP178 as Output Pin */
#define OUT_PIN_PPS_RP179			RPOR12bits.RP179R	/* Assign RP179 as Output Pin */
#define OUT_PIN_PPS_RP180			RPOR12bits.RP180R	/* Assign RP180 as Output Pin */
#define OUT_PIN_PPS_RP181			RPOR13bits.RP181R	/* Assign RP181 as Output Pin */

#elif defined (_PPI_PPS_V6)
#define OUT_PIN_PPS_RP32			RPOR0bits.RP32R		/* Assign RP32 as Output Pin */
#define OUT_PIN_PPS_RP33			RPOR0bits.RP33R		/* Assign RP33 as Output Pin */
#define OUT_PIN_PPS_RP34			RPOR1bits.RP34R		/* Assign RP34 as Output Pin */
#define OUT_PIN_PPS_RP35			RPOR1bits.RP35R		/* Assign RP35 as Output Pin */
#define OUT_PIN_PPS_RP36			RPOR2bits.RP36R		/* Assign RP36 as Output Pin */
#define OUT_PIN_PPS_RP37			RPOR2bits.RP37R		/* Assign RP37 as Output Pin */
#define OUT_PIN_PPS_RP38			RPOR3bits.RP38R		/* Assign RP38 as Output Pin */
#define OUT_PIN_PPS_RP39			RPOR3bits.RP39R		/* Assign RP39 as Output Pin */
#define OUT_PIN_PPS_RP40			RPOR4bits.RP40R		/* Assign RP40 as Output Pin */
#define OUT_PIN_PPS_RP41			RPOR4bits.RP41R		/* Assign RP41 as Output Pin */
#define OUT_PIN_PPS_RP42			RPOR5bits.RP42R		/* Assign RP42 as Output Pin */
#define OUT_PIN_PPS_RP43			RPOR5bits.RP43R		/* Assign RP43 as Output Pin */
#define OUT_PIN_PPS_RP44			RPOR6bits.RP44R		/* Assign RP44 as Output Pin */
#define OUT_PIN_PPS_RP45			RPOR6bits.RP45R		/* Assign RP45 as Output Pin */
#define OUT_PIN_PPS_RP46			RPOR7bits.RP46R		/* Assign RP46 as Output Pin */
#define OUT_PIN_PPS_RP47			RPOR7bits.RP47R		/* Assign RP47 as Output Pin */
#define OUT_PIN_PPS_RP48			RPOR8bits.RP48R		/* Assign RP48 as Output Pin */
#define OUT_PIN_PPS_RP49			RPOR8bits.RP49R		/* Assign RP49 as Output Pin */
#define OUT_PIN_PPS_RP50			RPOR9bits.RP50R		/* Assign RP50 as Output Pin */
#define OUT_PIN_PPS_RP51			RPOR9bits.RP51R		/* Assign RP51 as Output Pin */
#define OUT_PIN_PPS_RP52			RPOR10bits.RP52R	/* Assign RP52 as Output Pin */
#define OUT_PIN_PPS_RP53			RPOR10bits.RP53R	/* Assign RP53 as Output Pin */
#define OUT_PIN_PPS_RP54			RPOR11bits.RP54R	/* Assign RP54 as Output Pin */
#define OUT_PIN_PPS_RP55			RPOR11bits.RP55R	/* Assign RP55 as Output Pin */
#define OUT_PIN_PPS_RP56			RPOR12bits.RP56R	/* Assign RP56 as Output Pin */
#define OUT_PIN_PPS_RP57			RPOR12bits.RP57R	/* Assign RP57 as Output Pin */
#define OUT_PIN_PPS_RP58			RPOR13bits.RP58R	/* Assign RP58 as Output Pin */
#define OUT_PIN_PPS_RP59			RPOR13bits.RP59R	/* Assign RP59 as Output Pin */
#define OUT_PIN_PPS_RP60			RPOR14bits.RP60R	/* Assign RP60 as Output Pin */
#define OUT_PIN_PPS_RP61			RPOR14bits.RP61R	/* Assign RP61 as Output Pin */
#define OUT_PIN_PPS_RP62			RPOR15bits.RP62R	/* Assign RP62 as Output Pin */
#define OUT_PIN_PPS_RP63			RPOR15bits.RP63R	/* Assign RP63 as Output Pin */
#define OUT_PIN_PPS_RP176			RPOR16bits.RP176R	/* Assign RP176 as Output Pin */
#define OUT_PIN_PPS_RP177			RPOR16bits.RP177R	/* Assign RP177 as Output Pin */
#define OUT_PIN_PPS_RP178			RPOR17bits.RP178R	/* Assign RP178 as Output Pin */
#define OUT_PIN_PPS_RP179			RPOR17bits.RP179R	/* Assign RP179 as Output Pin */
#define OUT_PIN_PPS_RP180			RPOR18bits.RP180R	/* Assign RP180 as Output Pin */
#define OUT_PIN_PPS_RP181			RPOR18bits.RP181R	/* Assign RP181 as Output Pin */
